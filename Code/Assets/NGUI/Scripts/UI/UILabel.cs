...
public class UILabel : UIWidget
{
	...
	public delegate string GetWordConfigDelegate(int _code);
	private static GetWordConfigDelegate	m_wordconfigDelegate = null;
	public static void SetWordConfigDelegate(GetWordConfigDelegate _delegate)
	{
		m_wordconfigDelegate = _delegate;
	}
	
	public string GetWordConfig(int _code)
	{
		if(m_wordconfigDelegate != null)
			return m_wordconfigDelegate(_code);
		return "";
	}
	...
	[HideInInspector][SerializeField] int mTextID = 0;
