...
public class UIRoot : MonoBehaviour
{
	...
	public int activeHeight
	{
		get
		{
			...
			if (scalingStyle == Scaling.FixedSize || scalingStyle == Scaling.FixedSizeofWidth) return manualHeight;
			int w = Screen.width;
	...
	protected virtual void Start ()
	{
		...
		if(mTrans != null && Globals.Instance.MGUIManager != null){
			mTrans.localScale = new Vector3(localScale.x * Globals.Instance.MGUIManager.widthRatio,localScale.y * Globals.Instance.MGUIManager.heightRatio,localScale.z);
		}
		return;
