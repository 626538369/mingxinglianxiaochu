...
public class DotUICenterOnChild : MonoBehaviour
{
	/// <summary>
	...
	public GameObject DotePrefab1;
	public GameObject DotePrefab2;
	public GameObject DotePrefab3;
	public GameObject DotePrefab4;
	...
	void InitDot(GameObject CenterObject)
	{
		if(CenterObject.name == "FaceStore1")
		{
			NGUITools.SetActive(DotePrefab1.gameObject,true);
			NGUITools.SetActive(DotePrefab2.gameObject,false);
			NGUITools.SetActive(DotePrefab3.gameObject,false);
			NGUITools.SetActive(DotePrefab4.gameObject,false);
		}
		else if(CenterObject.name == "FaceStore2")
		{
			NGUITools.SetActive(DotePrefab1.gameObject,false);
			NGUITools.SetActive(DotePrefab2.gameObject,true);
			NGUITools.SetActive(DotePrefab3.gameObject,false);
			NGUITools.SetActive(DotePrefab4.gameObject,false);
		}
		else if(CenterObject.name == "FaceStore3")
		{
			NGUITools.SetActive(DotePrefab1.gameObject,false);
			NGUITools.SetActive(DotePrefab2.gameObject,false);
			NGUITools.SetActive(DotePrefab3.gameObject,true);
			NGUITools.SetActive(DotePrefab4.gameObject,false);
		}
		else if(CenterObject.name == "FaceStore4")
		{
			NGUITools.SetActive(DotePrefab1.gameObject,false);
			NGUITools.SetActive(DotePrefab2.gameObject,false);
			NGUITools.SetActive(DotePrefab3.gameObject,false);
			NGUITools.SetActive(DotePrefab4.gameObject,true);
		}
	}
}
