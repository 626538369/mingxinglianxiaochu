...
public class UIProgressBar : UIWidgetContainer
{
	...
	protected bool isHorizontal { get { return (mFill == FillDirection.LeftToRight || mFill == FillDirection.RightToLeft || mFill == FillDirection.CenterToBorder); } }
	...
	public virtual void ForceUpdate ()
	{
		...
		if (mFG != null)
		{
			...
			if (isHorizontal)
			{
				...
				{
					if (mFill == FillDirection.CenterToBorder)
					{
