...
public class UISpriteAnimationInspector : Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		bool pingPong = EditorGUILayout.Toggle("PingPong", anim.pingPong);
		
		if (anim.pingPong != pingPong)
		{
			NGUIEditorTools.RegisterUndo("Sprite Animation Change", anim);
		...
		bool makePixelPerfect = EditorGUILayout.Toggle("MakePixelPerfect", anim.makePixelPerfect);
		
		if (anim.makePixelPerfect != makePixelPerfect)
		{
			NGUIEditorTools.RegisterUndo("Sprite Animation Change", anim);
			anim.makePixelPerfect = makePixelPerfect;
			EditorUtility.SetDirty(anim);
		}
	}
}