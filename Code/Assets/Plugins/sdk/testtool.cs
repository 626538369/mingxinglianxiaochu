...
public class testtool : MonoBehaviour
{
    ...
    void Start()
    {
        panel_phone = this.transform.Find("phone");
        panel_wallet = this.transform.Find("wallet");
        panel_notice = this.transform.Find("notice");
        panel_password = this.transform.Find("wallet_password");
        panel_main = this.transform.Find("main");
        input_phone = panel_phone.Find("phone_num").GetComponent<InputField>();
        input_code = panel_phone.Find("phone_code").GetComponent<InputField>();
        input_wallet_password = panel_wallet.Find("wallet_open/wallet_password").GetComponent<InputField>();
        input_wallet_password2 = panel_password.Find("wallet_password").GetComponent<InputField>();
        input_recharge_num = panel_main.Find("rechargenum/num").GetComponent<InputField>();
        input_recharge_num.text = "0";
        txt_name = panel_main.Find("name").GetComponent<Text>();
        txt_address = panel_main.Find("address").GetComponent<Text>();
        txt_gas = panel_main.Find("gas").GetComponent<Text>();
        txt_sgas = panel_main.Find("sgas").GetComponent<Text>();
        btn_main = this.transform.Find("btn_main").GetComponent<Button>();

        if (PlayerPrefs.HasKey("phone"))
            input_phone.text = PlayerPrefs.GetString("phone");

        //提示ui
        txt_notcie = panel_notice.Find("txt").GetComponent<Text>();
        panel_notice.Find("bg").GetComponent<Button>().onClick.AddListener(() =>
        {
            panel_notice.gameObject.SetActive(false);
        });

        //手机号登入ui
        panel_phone.Find("login").GetComponent<Button>().onClick.AddListener(onCLick_phone_login);
        panel_phone.Find("get_num").GetComponent<Button>().onClick.AddListener(onCLick_phone_code);

        //钱包导入ui
        panel_wallet.Find("creat").GetComponent<Button>().onClick.AddListener(onCLick_wallet_creat);
        panel_wallet.Find("open").GetComponent<Button>().onClick.AddListener(onCLick_wallet_open);
        panel_wallet.Find("wallet_open/wallet_file").GetComponent<Button>().onClick.AddListener(onCLick_wallet_open2);
        panel_wallet.Find("wallet_open/open").GetComponent<Button>().onClick.AddListener(onCLick_wallet_open3);
        
        panel_wallet.Find("wallet_open/close").GetComponent<Button>().onClick.AddListener(() =>
        {
            panel_wallet.Find("wallet_open").gameObject.SetActive(false);
        });

        //钱包密码登入ui
        panel_password.Find("open").GetComponent<Button>().onClick.AddListener(onClick_wallet_password);

        //主界面ui
        panel_main.Find("recharge").GetComponent<Button>().onClick.AddListener(() =>
        {
            recharge_type = 0;
            panel_main.Find("rechargenum").gameObject.SetActive(true);
        });
        panel_main.Find("game_recharge").GetComponent<Button>().onClick.AddListener(() =>
        {
            recharge_type = 1;
            panel_main.Find("rechargenum").gameObject.SetActive(true);
        });
        panel_main.Find("rechargenum/ok").GetComponent<Button>().onClick.AddListener(onClick_Recharge);
        panel_main.Find("refresh").GetComponent<Button>().onClick.AddListener(onClick_Refresh);
        panel_main.Find("loginout").GetComponent<Button>().onClick.AddListener(onLoginOut);
    ...
    void showOpenWallet(string files = "")
    {
        ...
        if (files == "")
        {
            panel_wallet.Find("wallet_open/wallet_file/Placeholder").gameObject.SetActive(true);
            panel_wallet.Find("wallet_open/wallet_file/Text").gameObject.SetActive(false);
        }
        else
        {
            panel_wallet.Find("wallet_open/wallet_file/Placeholder").gameObject.SetActive(false);
            panel_wallet.Find("wallet_open/wallet_file/Text").gameObject.SetActive(true);
            panel_wallet.Find("wallet_open/wallet_file/Text").GetComponent<Text>().text = files;
        }
    }
    ...
    {
        showOpenWallet("");
        panel_wallet.Find("wallet_open").gameObject.SetActive(true);
    }
    ...
    {
        panel_main.Find("rechargenum").gameObject.SetActive(false);
