...
public class PackedSprite : AutoSpriteBase
{
	...
	private TextureAnim[] TextureAnimations
	{
		get
		{
			if(mPackedSprite != null)
			{
				return mPackedSprite.TextureAnimations;
			}
			else
			{
	...
	private PackedSprite mPackedSprite = null;
	public string StaticSpriteName;
