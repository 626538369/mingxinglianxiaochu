...
public abstract class SpriteRoot : MonoBehaviour, IEZLinkedListItem<ISpriteAnimatable>, IUseCamera
{
	...
	/// <summary>
	/// tzz added for hide the button
	/// Sprite hided delegate declare
	/// </summary>
	public delegate void SpriteHidedDelegate(SpriteRoot _sprite,bool _hide);
	
	/// <summary>
	/// Occurs when m_hided event.
	/// </summary>
	protected SpriteHidedDelegate m_hidedEvent = null;
	
	/// <summary>
	/// Sets the hided delegate event
	/// </summary>
	/// <param name='_delegate'>
	/// _delegate.
	/// </param>
	public void SetHidedDelegate(SpriteHidedDelegate _delegate){
		m_hidedEvent = _delegate;
	}
	
	//! get the hided deleaget
	public SpriteHidedDelegate GetHidedDelegate(){
		return m_hidedEvent;
	}
	...
	*/
	...
	public virtual void Delete()
	{
		...
		// Destroy our mesh:
		if (!managed && Application.isPlaying && spriteMesh != null)
		{
...
*/
	...
	public virtual void Hide(bool tf)
	{
		...
		// tzz added for hide event
		if(m_hidedEvent != null){
			m_hidedEvent(this,tf);
		}
	}
