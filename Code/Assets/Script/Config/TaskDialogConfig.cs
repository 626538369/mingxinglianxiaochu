...
public class TaskDialogConfig : ConfigBase
{
	public class TaskDialogObject
	{
		...
		public int effectIDHead = -1;
		public int effectIDTail = -1;
		public string talkCaptionName;
		public string talkContent;
		public string talkMusic;
		public string MoodBG1;
	}
	...
	public override bool Load (SecurityElement element)
	{
		...
		if(element.Children !=null)
		{
			...
			foreach(SecurityElement childrenElement in element.Children)
			{
				...
				talkObject.effectIDHead = StrParser.ParseDecInt(StrParser.ParseStr(childrenElement.Attribute("EffectIDHead"),""), -1);
				talkObject.effectIDTail = StrParser.ParseDecInt(StrParser.ParseStr(childrenElement.Attribute("EffectIDTail"),""), -1);
				...
				talkObject.MoodBG1 = StrParser.ParseStr(childrenElement.Attribute("EffectIDTail"),"");
